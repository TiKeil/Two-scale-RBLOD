...
#SBATCH --nodes=16                   # the number of nodes you want to reserve
...
#SBATCH --job-name=test_henning     # the name of your job
#SBATCH --mail-type=ALL             # receive an email when your job starts, finishes normally or is aborted
#SBATCH --mail-user=t_keil02@uni-muenster.de # your mail address

# set an output file
#SBATCH --output /scratch/tmp/USER/RBLOD/final/model_problem_1.dat
